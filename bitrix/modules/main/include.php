...
/*ZDUyZmZMzE3OGVhYzU2NmE2ZGNiMGJmZWQwZjZhODAzZGFlM2E=*/$GLOBALS['____438581287']= array(base64_decode('ZG'.'VmaW5l'));if(!function_exists(__NAMESPACE__.'\\___1099545769')){function ___1099545769($_2069507366){static $_1950263720= false; if($_1950263720 == false) $_1950263720=array('R'.'U5D'.'T'.'0RF',''.'WQ==');return base64_decode($_1950263720[$_2069507366]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1429329614){ return true;} public static function IsFeatureEditable($_1429329614){ return true;} public static function SetFeatureEnabled($_1429329614, $_1847180320= true){} public static function SaveFeaturesSettings($_1138972046, $_141498881){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_632328718){} public static function ModifyFeaturesSettings($_632328718, $_1760771515){} public static function IsFeatureInstalled($_1429329614){ return true;}} $GLOBALS['____438581287'][0](___1099545769(0), ___1099545769(1));/**/			//Do not remove this
