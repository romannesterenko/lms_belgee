        ...
        <div class="content">
            ...
            <div class="content-block">
                <div class="content-nav content-nav--top">
                    <span><a href="/cabinet/dealer/employees/<?=$id?>/"><?= Loc::getMessage('EMPLOYEE_PROFILE') ?></a></span>
                    <span><a href="/cabinet/dealer/employees/passing/<?=$id?>/"><?= Loc::getMessage('IN_COURSES') ?></a></span>
                    <span class="active"><a href="/cabinet/dealer/employees/passed/<?=$id?>/"><?= Loc::getMessage('COMPLETED_COURSES') ?></a></span>
