    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                <h2 class="h2 center">Загрузка файла подписок</h2>
                <div class="form-div">
                    <form class="report_form" action="" method="post" style="">
                        ...
                        <p>Файл с расширением .xlsx, заполненный согласно шаблона. <a href="/upload/Технический_тренер_новые_модели_2024.xlsx" download="example">Скачать пример файла</a></p>
    ...
    <script>
        $(function (){
            $(document).on('click', '.load_data', function (e){
                ...
                $.ajax({
                    type: 'POST',
                    url: '/local/templates/geely/ajax/load_test_subscriptions_data.php',
                    data: formData,
                    processData: false,
                    contentType: false,
                    dataType: 'html',
            ...
            $(document).on('click', '.load_test_subscriptions', function (e){
                e.preventDefault();
                const file_id = $(this).data('file-id');
                $.ajax({
                    type: 'POST',
                    url: '/local/templates/geely/ajax/load_subscriptions.php',
                    data: {
                        file_id: file_id,
                    },
                    dataType: 'html',
