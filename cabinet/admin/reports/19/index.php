    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                <h2 class="h2 center" style="margin-bottom:10px">Уровни сотрудников</h2>
                ...
                <div class="form-div">
                    <form class="report_generator" action="report.php" method="post" style="">
                        ...
                        <div class="form-group selectable">
                            <label for="">Уровень сотрудника</label>
                            <select class="js-example-basic-multiple" name="employee_level[]" multiple="multiple" style="width: 100%;">
                                <option value="0">Без уровня</option>
                                <?php foreach ($level_list as $level_id => $level){?>
                                    <option value="<?=$level_id?>"<?=$_REQUEST['employee_level']&&in_array($level_id, $_REQUEST['employee_level'])?' selected':''?>><?=$level?> уровень</option>
                                <?php }?>
                            </select>
                        </div>
