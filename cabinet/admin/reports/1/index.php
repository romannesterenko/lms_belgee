    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                <h2 class="h2 center" style="margin-bottom:10px">Отчет по дилеру</h2>
                ...
                <div class="form-div">
                    <form class="report_generator" action="report.php" method="post" style="">
                        <div class="form-group selectable">
                            ...
                            <select class="js-example-basic-multiple" name="dealer_codes" style="width: 100%;">
                        ...
                        <div class="form-group selectable">
                            ...
                            <select class="js-example-basic-multiple" name="dealer_names" style="width: 100%;">
