...
$trainers = \Teaching\Trainers::getAll();
$courses = \Models\Course::getList(['!PROPERTY_COURSE_TYPE' => 5], ['ID', 'NAME']);
$questions = \Models\FeedbackPoll::getAllQuestions(true);
//dump($questions);
?>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                <h2 class="h2 center" style="margin-bottom:10px">Отчет по обратной связи</h2>
                <h4 class="h4 center">Предварительный фильтр</h4>
                <div class="form-div">
                    <form class="report_generator" action="report_new.php" method="post" style="">
                        <div class="form-group selectable">
                            <label for="">Тренер</label>
                            <select class="js-example-basic-multiple" name="trainer[]" multiple="multiple"  style="width: 100%;">
                        ...
                        <div class="form-group selectable">
                            ...
                            <select class="js-example-basic-multiple" name="course[]" multiple="multiple" style="width: 100%;">
                        ...
                        <div class="form-group selectable">
                            ...
                            <select class="js-example-basic-multiple" name="questions[]" multiple="multiple" style="width: 100%;">
                                <?php foreach ($questions as $id => $theme){?>
                                    <option value="" disabled><?=$theme['THEME']['NAME']?></option>
