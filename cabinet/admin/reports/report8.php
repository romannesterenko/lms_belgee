...
?>
    ...
    <div class="content-block">
        ...
        <div class="form-div">
            <form class="report_generator" action="report8_report.php" method="post" style="">
                ...
                <?php /*<div style="display: flex; justify-content: space-between;">
                        <div class="form-group" style="width: 100%;margin-right: 20px;">
                            <label for="">Дата последнего посещения портала  LMS от</label>
                            <input type="date" name="last_authorization_before">
                        </div>
                        <div class="form-group" style="width: 100%;">
                            <label for="">Дата последнего посещения портала  LMS до</label>
                            <input type="date" name="last_authorization_after">
                        </div>
                    </div>*/?>
                <div class="form-group selectable">
                    <label for="">ФИО</label>
