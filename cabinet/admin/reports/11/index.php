    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                    <h2 class="h2 center" style="margin-bottom:10px">Отчет по тестированию</h2>
                ...
                <form class="report_generator" action="report.php" method="post" style="">
                    ...
                    <div style="display: flex; justify-content: left;">
                        ...
                        <div class="form-group" style="margin-right: 5px; width: 40%">
                            <label for="">Диапазон дат от</label>
                            <input type="date" style="border-radius: 4px;" name="date_from">
                        </div>
                        <div class="form-group"  style="margin-right: 5px; width: 40%">
                            <label for="">Диапазон дат до</label>
                            <input type="date" style="border-radius: 4px;" name="date_to">
                        </div>
                    </div>
