    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                    <h2 class="h2 center" style="margin-bottom:10px">Расписание модулей в расписании на месяц</h2>
                ...
                <form class="report_generator" action="report.php" method="post" style="">
                    ...
                    <div style="display: flex; justify-content: left;">
                        ...
                        <div class="form-group selectable" style="margin-right: 5px; width: 40%">
