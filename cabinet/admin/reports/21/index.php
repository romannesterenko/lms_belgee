...
$course_formats = \Helpers\PropertyHelper::getPropertyValuesList(\Models\Course::getIblockId(), 'COURSE_FORMAT');
?>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                <h2 class="h2 center" style="margin-bottom:10px">Рейтинг обученности дилеров по курсам</h2>
                ...
                <div class="form-div">
                    <form class="report_generator" action="report.php" method="post" style="">
                        ...
                        <div class="form-group selectable">
                            <label for="">Формат курса</label>
                            <select class="js-example-basic-multiple" name="course_format" style="width: 100%;">
                                <option value="">Все форматы</option>
                                <?php foreach ($course_formats as $prop_id => $course_format) {?>
                                    <option value="<?=$prop_id?>"><?=$course_format?></option>
                                <?php }?>
                            </select>
                        </div>
