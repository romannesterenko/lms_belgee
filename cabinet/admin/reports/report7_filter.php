    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="content-block">
                <h2 class="h2 center">Отчет по посещаемости тренингов</h2>
                <div class="form-div">
                    <form class="report_generator" action="report7.php" method="post" style="">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            <div class="form-group" style="width: 100%;margin-right: 20px;">
                                <label for="">Период от</label>
                                <div style="display: flex">
                                    <select name="from_month" id="" class="js-example-basic-multiple" style="width: 100%;">
                                        <option value="all">Месяц</option>
                                        <?php foreach ($months as $num => $month){?>
                                            <option value="<?=$num?>"><?=$month?></option>
                                        <?php }?>
                                    </select>
                                    <select name="from_year" id="" class="js-example-basic-multiple" style="width: 100%;">
                            ...
                            <div class="form-group" style="width: 100%;">
                                <label for="">Период до</label>
                                <div style="display: flex">
                                    <select name="to_month" id="" class="js-example-basic-multiple"  style="width: 100%; margin-right: 5px">
                                        <option value="all">Месяц</option>
                                        <?php foreach ($months as $num => $month){?>
                                            <option value="<?=$num?>"><?=$month?></option>
                                        <?php }?>
                                    </select>
                                    <select name="to_year" id="" class="js-example-basic-multiple" style="width: 100%;">
                                        <option value="all">Год</option>
                                        <?php foreach ($years as $year){?>
                                            <option value="<?=$year?>"><?=$year?></option>
                                        <?php }?>
