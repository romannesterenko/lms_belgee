...
if (check_full_array($arResult['ITEM'])){?>
    <div class="timetable-item list_item_card" data-id="<?=$arResult['ITEM']['ID']?>">
        <?php if($_REQUEST['ajax_card']=='Y')
            ...
            <a href="/shedules/<?=$arResult['ITEM']['SCHEDULE']['ID']?>/">
                ...
                <span class="timetable-item__content">
                    ...
                    <span class="timetable-item__title"><?=$arResult['ITEM']['SCHEDULE']['NAME']?></span>
                    <span class="timetable-item__text"><?=$arResult['ITEM']['SCHEDULE']['PREVIEW_TEXT']??$arResult['ITEM']['PREVIEW_TEXT']?></span>
