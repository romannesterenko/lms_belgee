...
<?php endif?>
	...
	<div class="alert alert-success"><?php echo GetMessage("AUTH_EMAIL_SENT")?></div>
    <?php endif?>

    <?php if(!$arResult["SHOW_EMAIL_SENT_CONFIRMATION"] && $arResult["USE_EMAIL_CONFIRMATION"] === "Y"):?>
	<div class="alert alert-warning"><?php echo GetMessage("AUTH_EMAIL_WILL_BE_SENT")?></div>
    <?php endif?>
...
<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="regform">
	...
	<div class="bx-authform-formgroup-container">
		<div class="bx-authform-label-container"><span class="bx-authform-starrequired">*</span><?php echo GetMessage("main_register_sms_code")?></div>
	...
	<div class="bx-authform-formgroup-container">
		<input type="submit" class="btn btn-primary" name="code_submit_button" value="<?php echo GetMessage("main_register_sms_send")?>" />
	</div>
	...
	<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data">
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				...
				<div class="bx-authform-psw-protected" id="bx_auth_secure" style="display:none"><div class="bx-authform-psw-protected-desc"><span></span><?php echo GetMessage("AUTH_SECURE_NOTE")?></div></div>
...
document.getElementById('bx_auth_secure').style.display = '';
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
                <?php if($arResult["SECURE_AUTH"]):?>
				<div class="bx-authform-psw-protected" id="bx_auth_secure_conf" style="display:none"><div class="bx-authform-psw-protected-desc"><span></span><?php echo GetMessage("AUTH_SECURE_NOTE")?></div></div>
...
document.getElementById('bx_auth_secure_conf').style.display = '';
		...
		<div class="bx-authform-formgroup-container">
			<div class="bx-authform-label-container"><?php if($arResult["EMAIL_REQUIRED"]):?><span class="bx-authform-starrequired">*</span><?php endif?><?=GetMessage("AUTH_EMAIL")?></div>
			<div class="bx-authform-input-container">
		...
		<div class="bx-authform-formgroup-container">
			<div class="bx-authform-label-container"><?php if($arResult["PHONE_REQUIRED"]):?><span class="bx-authform-starrequired">*</span><?php endif?><?php echo GetMessage("main_register_phone_number")?></div>
			<div class="bx-authform-input-container">
		...
		<div class="bx-authform-formgroup-container">
			<div class="bx-authform-label-container"><?php if ($arUserField["MANDATORY"]=="Y"):?><span class="bx-authform-starrequired">*</span><?php endif?><?=$arUserField["EDIT_FORM_LABEL"]?></div>
			<div class="bx-authform-input-container">
                <?php
